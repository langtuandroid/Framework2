...
public class NP_PlayAnimActionNode : NP_TaskNodeBase
{
    ...
    public NP_ActionNodeData NP_ActionNodeData = new()
        { NpClassForStoreAction = new NP_PlayAnimAction() };
    ...
    public override string CreateNodeName => nameof(NP_PlayAnimAction);
