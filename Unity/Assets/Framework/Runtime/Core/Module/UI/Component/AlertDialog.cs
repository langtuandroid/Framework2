...
namespace Framework
{
    public class AlertDialog
    {
            ...
            Action<int> clickCallback)
        {
            ...
            AlertDialogView window = (await Root.Instance.Scene.GetComponent<UIComponent>().OpenAsync<AlertDialogView>()) as AlertDialogView;
        ...
        public static async Task<AlertDialog> ShowMessage(AlertDialogVM viewModel)
        {
            ...
            try
            {
                view = await Root.Instance.Scene.GetComponent<UIComponent>().OpenAsync<AlertDialogView>() as AlertDialogView;
            ...
            {
                if (view != null)
                    Root.Instance.Scene.GetComponent<UIComponent>().Close(view);
                Log.Error(e);
                throw;
            }
        }
