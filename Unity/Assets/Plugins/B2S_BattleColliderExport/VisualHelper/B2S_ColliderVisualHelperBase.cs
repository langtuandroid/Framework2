...
namespace ET
{
    public abstract class B2S_ColliderVisualHelperBase
    {
        ...
        protected B2S_ColliderDataStructureBase dataStructureBase;

        protected B2S_ColliderEditor colliderEditor;

        public B2S_ColliderVisualHelperBase(B2S_ColliderEditor colliderEditor)
        {
        ...
        public bool SavecolliderNameAndIdInflect()
        {
            ...
            using (FileStream file =
                   File.Create($"{B2S_BattleColliderExportPathDefine.ColliderNameAndIdInflectSavePath}/{B2S_BattleColliderExportPathDefine.NameAndIdInflectFileName}.bytes"))
            {
        ...
        protected void SavePrefab()
        {
            PrefabUtility.SaveAsPrefabAsset(theObjectWillBeEdited,
                $"{B2S_BattleColliderExportPathDefine.ColliderPrefabSavePath}/{theObjectWillBeEdited.name}.prefab");
        }
        ...
        public virtual void DeletecolliderData()
        {
            ...
            using (FileStream file =
                   File.Create(
                       $"{B2S_BattleColliderExportPathDefine.ColliderNameAndIdInflectSavePath}/{B2S_BattleColliderExportPathDefine.NameAndIdInflectFileName}.bytes"))
            {
                BsonSerializer.Serialize(new BsonBinaryWriter(file), this.MColliderNameAndIdInflectSupporter);
            }
