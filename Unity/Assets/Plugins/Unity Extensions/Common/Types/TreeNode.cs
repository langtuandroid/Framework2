...
namespace UnityExtensions
{
    ...
    /// </summary>
    [Serializable]
    internal class TreeNode<Node> where Node : TreeNode<Node>
    {
...
#region Enumerable & Enumerator
        ...
        internal struct ChildrenEnumerable
        {
            Node _node;
        ...
        internal struct ParentsEnumerable
        {
            Node _node;
        ...
        internal struct ParentsEnumerator
        {
            Node _node;
        ...
        internal struct DirectChildrenEnumerable
        {
            Node _node;
