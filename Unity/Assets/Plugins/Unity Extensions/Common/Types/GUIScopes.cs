...
{
    internal struct GUIContentColorScope : IDisposable
    {
        Color _orginal;
    ...
    internal struct GUIBackgroundColorScope : IDisposable
    {
        Color _orginal;
    ...
    internal struct GUILayoutAreaScope : IDisposable
    {
    ...
    internal struct GUILayoutHorizontalScope : IDisposable
    {
    ...
    internal struct GUILayoutVerticalScope : IDisposable
    {
    ...
    internal struct GUILayoutScrollViewScope : IDisposable
    {
