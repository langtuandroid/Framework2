...
namespace UnityExtensions.Editor
{
    ...
    internal struct WideModeScope : IDisposable
    {
        bool _orginal;
    ...
    internal struct IndentLevelScope : IDisposable
    {
        int _indent;
    ...
    internal struct GizmosColorScope : IDisposable
    {
        Color _orginal;
    ...
    internal struct GizmosMatrixScope : IDisposable
    {
        Matrix4x4 _orginal;
    ...
    internal struct HandlesGUIScope : IDisposable
    {
