...
/// Box2D形状使用函数集
/// </summary>
public static class B2D_FixtureUtility
{
    /// <summary>
    /// 为刚体挂载一个矩形碰撞体
    /// </summary>
    ...
    public static void CreateBoxFixture(this Body self, float hx, float hy, UnityEngine.Vector2 offset, float angle,
        bool isSensor, object userData)
    {
    ...
    /// <param name="isSensor">是否为触发器</param>
    /// <param name="userData">用户自定义信息</param>
    public static void CreateCircleFixture(this Body self, float radius, UnityEngine.Vector2 offset, bool isSensor,
        object userData)
    {
