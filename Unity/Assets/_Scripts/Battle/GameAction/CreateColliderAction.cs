...
public class CreateColliderAction : SkillBaseAction
{
    [Required] [LabelText("碰撞体的路径")] public string ColliderPath;
    ...
    {
        UnitFactory.CreateSpecialColliderUnit(BelongToUnit.DomainScene(), BelongToUnit.Id,
            ColliderNPBehaveTreeIdInExcel, HangPoint, FollowUnitPos, FollowUnitRot, Offset, Angle);
    }
}