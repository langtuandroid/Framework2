...
/// 行为树里的默认碰撞器
/// </summary>
public class BehaveDefaultCollisionHandler : ACollisionHandler
{
    public override void HandleCollisionStart(ColliderUserData a, ColliderUserData b)
    {
        BehaveDefaultColliderData aColliderData = a.UserData as BehaveDefaultColliderData;
    ...
    private void BroadcastCollider(ColliderComponent aColliderComponent, ColliderComponent bColliderComponent,
        BehaveDefaultColliderData aColliderData)
    {
