...
public class NP_LoadSubTreeData : NP_NodeDataBase, IGraphNodeDeserialize
{
    ...
    [LabelText("从那边拿到的数据")]
    public SerializeDictionary<NP_BlackBoardKeyData, NP_OtherTreeBBKeyData> GetValue = new();
    ...
    public override ExtraBehave CreateTree(Unit unit, NP_RuntimeTree runtimeTree)
    {
        ...
        behave.Root = NP_RuntimeTreeFactory.LoadSubTree(unit, runtimeTree, ConfigId, behave);
        return behave;
    }
    ...
    private void CustomAddGetValue(List<SerializeDicKeyValue<NP_BlackBoardKeyData, NP_OtherTreeBBKeyData>> obj)
    {
        ...
        obj.Add(new SerializeDicKeyValue<NP_BlackBoardKeyData, NP_OtherTreeBBKeyData>(new NP_BlackBoardKeyData(),
            otherKeyData));
    }
